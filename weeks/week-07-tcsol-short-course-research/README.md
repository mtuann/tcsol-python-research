...
- Question: In a short-term Chinese course, which activity focus produces clearer learner-task evidence for the target structure?
- Unit of analysis: one synthetic learner task record.
- Dataset: synthetic short-course TCSOL task data with rubric scores and teacher notes.
...
- [ ] Choose a realistic short-course `target_structure`.
