...
| `lesson_phase` | text | review, notice, compare, controlled practice, communicative practice, feedback, or assessment | phase-minutes table |
...
| `learner_difficulty` | numeric | 1 low to 3 high | adaptation score |
